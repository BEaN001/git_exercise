...
save_dir = '/Users/binyu/Documents/git_exercise/computer_vision/projects/human_detection/objectdetection_data/native_48'
...
f1 = open('/Users/binyu/Documents/git_exercise/computer_vision/projects/human_detection/objectdetection_data/native_48/pos_48.txt', 'w')
f2 = open('/Users/binyu/Documents/git_exercise/computer_vision/projects/human_detection/objectdetection_data/native_48/neg_48.txt', 'w')
f3 = open('/Users/binyu/Documents/git_exercise/computer_vision/projects/human_detection/objectdetection_data/native_48/part_48.txt', 'w')
...
for label in labels:
    ...
    while neg_num < 40:
        size_x = np.random.randint(48, min(width, height) / 3)
        size_y = 3 * size_x
