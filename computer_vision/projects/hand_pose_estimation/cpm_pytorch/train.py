from computer_vision.projects.hand_pose_estimation.cpm_pytorch.data_loader.cmu_hand_data import CMUHand as Mydata
from computer_vision.projects.hand_pose_estimation.cpm_pytorch.model.cpm import CPM
